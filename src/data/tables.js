...
export const MRCI_TABLES = {
  ...
  forms: {
    ...
    other_dry_powder_inhalers: { weight: 3, label: "Inhalador de polvo seco", routeGroup: "inhalation" },
    dialysate: { weight: 5, label: "Dializado", routeGroup: "other" },
    enemas: { weight: 2, label: "Enema", routeGroup: "other" },
    injections_generic: { weight: 4, label: "Inyeccion generica", routeGroup: "other" },
    ...
    vaginal_creams: { weight: 2, label: "Crema vaginal/ovulo vaginal", routeGroup: "other" },
  },
  frequencies: {
    once_daily: { weight: 1, label: "Una vez al dia", administrationsPerDay: 1, prn: false },
    once_daily_prn: { weight: 0.5, label: "Una vez al dia PRN/Despierto", administrationsPerDay: 1, prn: true },
    twice_daily: { weight: 2, label: "Dos veces al dia", administrationsPerDay: 2, prn: false },
    twice_daily_prn: { weight: 1, label: "Dos veces al dia PRN/Despierto", administrationsPerDay: 2, prn: true },
    three_times_daily: { weight: 3, label: "Tres veces al dia", administrationsPerDay: 3, prn: false },
    three_times_daily_prn: { weight: 1.5, label: "Tres veces al dia PRN/Despierto", administrationsPerDay: 3, prn: true },
    four_times_daily: { weight: 4, label: "Cuatro veces al dia", administrationsPerDay: 4, prn: false },
    four_times_daily_prn: { weight: 2, label: "Cuatro veces al dia PRN/Despierto", administrationsPerDay: 4, prn: true },
    every_12_hours: { weight: 2.5, label: "Cada 12 horas", administrationsPerDay: 2, prn: false, fixedInterval: true, intervalHours: 12 },
    every_12_hours_prn: { weight: 1.5, label: "Cada 12 horas PRN/Despierto", administrationsPerDay: 2, prn: true, fixedInterval: true, intervalHours: 12 },
    every_8_hours: { weight: 3.5, label: "Cada 8 horas", administrationsPerDay: 3, prn: false, fixedInterval: true, intervalHours: 8 },
    every_8_hours_prn: { weight: 2, label: "Cada 8 horas PRN/Despierto", administrationsPerDay: 3, prn: true, fixedInterval: true, intervalHours: 8 },
    every_6_hours: { weight: 4.5, label: "Cada 6 horas", administrationsPerDay: 4, prn: false, fixedInterval: true, intervalHours: 6 },
    every_6_hours_prn: { weight: 2.5, label: "Cada 6 horas PRN/Despierto", administrationsPerDay: 4, prn: true, fixedInterval: true, intervalHours: 6 },
    every_4_hours: { weight: 6.5, label: "Cada 4 horas", administrationsPerDay: 6, prn: false, fixedInterval: true, intervalHours: 4 },
    every_4_hours_prn: { weight: 3.5, label: "Cada 4 horas PRN/Despierto", administrationsPerDay: 6, prn: true, fixedInterval: true, intervalHours: 4 },
    every_2_hours: { weight: 12.5, label: "Cada 2 horas", administrationsPerDay: 12, prn: false, fixedInterval: true, intervalHours: 2 },
    every_2_hours_prn: { weight: 6.5, label: "Cada 2 horas PRN/Despierto", administrationsPerDay: 12, prn: true, fixedInterval: true, intervalHours: 2 },
    ...
    oxygen_prn: { weight: 1, label: "Oxigeno PRN/Despierto", administrationsPerDay: null, prn: true },
...
export const AMRCI_REFERENCE = {
  ...
  formWeightOverrides: {
    injections_generic: {
      weight: 3.5,
      label: "Inyeccion generica",
      detail: "Ruta Injection de Appendix B: media entre prefilled (3) y ampule/vial (4).",
    },
    injections_prefilled: {
      weight: 3.5,
      label: "Inyectable precargado",
      detail: "Ruta Injection de Appendix B: peso unico A-MRCI para inyectables.",
    },
    ampules_vials: {
      weight: 3.5,
      label: "Inyectable ampolla/vial",
      detail: "Ruta Injection de Appendix B: peso unico A-MRCI para inyectables.",
    },
  },
  supportedAliases: {
  ...
  notes: [
    ...
    "Las rutas inyectables en A-MRCI puntuan 3.5 en Seccion A, sean precargadas, ampolla/vial o genericas no especificadas.",
