...
export const MRCI_TABLES = {
  ...
  forms: {
    ...
    injections_generic: { weight: 3, label: "Inyectable", routeGroup: "other" },
  ...
  instructions: {
    ...
    spacer_once_per_patient: {
      weight: 0,
      label: "Camara espaciadora (una vez por paciente)",
      mrciExcluded: true,
      amrciWeight: 3,
      oncePerRegimen: true,
    },
    prescribed_needles_once_per_patient: {
      weight: 0,
      label: "Agujas recetadas (una vez por paciente)",
      mrciExcluded: true,
      amrciWeight: 3,
      oncePerRegimen: true,
    },
...
export const AMRCI_REFERENCE = {
  ...
  formWeightOverrides: {
    ...
    injections_prefilled: {
      ...
      detail: "Ruta Injection de Appendix B: prefilled.",
    },
    ampules_vials: {
      weight: 4,
      label: "Inyectable ampolla/vial",
      detail: "Ruta Injection de Appendix B: ampule/vial.",
    },
  },
  supportedAliases: {
  ...
  notes: [
    ...
    "En A-MRCI, Inyectable generico puntua 3.5 en Seccion A; Inyectable precargado puntua 3 y ampolla/vial puntua 4.",
